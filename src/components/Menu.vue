    ...
    <div class="ctx">
      <div class="left">
        ...
        <a-sub-menu key="sub6">
            ...
            <a-menu-item key="staffManage">单位人员管理</a-menu-item>
        </a-sub-menu>
        <a-sub-menu key="sub7">
            <template #title>
...
<script lang='ts'>
import {HomeOutlined, UnlockOutlined,MailOutlined,FileSearchOutlined,
        PieChartOutlined,UsergroupDeleteOutlined,SettingOutlined,CaretRightOutlined,
        } from '@ant-design/icons-vue'
import { defineComponent, reactive, toRefs } from 'vue'
import { useRouter } from 'vue-router'
import '../assets/font/css/all.css'
import home_bar from '../views/home/components/home_bar.vue'
interface MenuData {
    key: string;
    keyPath: string[];
    item: object;
