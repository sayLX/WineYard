    ...
    <div class="body">
      ...
      <div class="form">
        <a-form layout="inline">
          <a-form-item label="姓名" name="mc">
            <div class="input">
              <a-input v-model:value="mc" placeholder="请输入">
              </a-input>
            </div>
          </a-form-item>
          <a-form-item label="工作证号" name="gzzh">
            <div class="input">
              <a-input v-model:value="gzzh" placeholder="请输入">
              </a-input>
            </div>
          </a-form-item>
          <a-form-item>
      ...
      <div class="person-list">
        ...
        <a-row
          ...
          :key="index1"
        >
          <a-col :span="item2.span" v-for="(item2,index2) in itemName" :key="index2" :class="item2.key">{{ item1[item2.key] }}</a-col>
          <a-col :span="3">
            <span>
              <!-- 编辑人员信息 -->
              <editPersonInfo
